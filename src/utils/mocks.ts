...
namespace Task {
    ...
    export const tasks: SbrfModel.SbrfTask[] = [
        ...
        createTask({id: '16', start: date(+60, '13:00'), end: date(+60, '15:00')}),
        createTask({id: '17', start: date(+60, '12:00'), end: date(+60, '13:30')}),
        createTask({id: '18', start: date(+60, '16:00'), end: date(+60, '18:00')}),
        createTask({id: '19', start: date(+59, '14:00'), end: date(+59, '17:00')}),
        createTask({id: '20', start: date(+61, '13:00'), end: date(+61, '16:00')}),
        createTask({id: '21'}),
        createTask({id: '22'}),
        createTask({id: '23'}),
        createTask({id: '24'}),
...
export function generateCalendarConfig(): Model.CalendarConfig {
    if (role === 'EFS_MRM_MONITORING_GEOPLEDGE_USER') {
        return generateGeomonitoringCalendarConfig()
    }
}

export function generatePlannerConfig(): SbrfModel.InteractionTaskConfigDetailsRs {
    if (role === 'EFS_MRM_MONITORING_GEOPLEDGE_USER') {
        return generateGeomonitoringPlannerConfig()
    }
}
